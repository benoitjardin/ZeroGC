...
public class LongObjectTreeMap extends LongTreeSet {
    ...
    public LongObjectTreeMap() {
    	this(LongObjectTreeMap.class.getSimpleName(), Store.INITIAL_CAPACITY, Store.GROWTH_FACTOR);
    }
    
    public LongObjectTreeMap(String name) {
        this(name, Store.INITIAL_CAPACITY, Store.GROWTH_FACTOR);
    }

    public LongObjectTreeMap(String name, int initialCapacity) {
    	this(name, initialCapacity, Store.GROWTH_FACTOR);
    }

    public LongObjectTreeMap(String name, int initialCapacity, float growthFactor) {
    ...
    public final int insert(long key, Object value) {
