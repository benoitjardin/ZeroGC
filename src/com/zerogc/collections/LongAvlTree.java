...
public class LongAvlTree {
    ...
    public LongAvlTree() {
        this(LongAvlTree.class.getSimpleName(), INITIAL_CAPACITY, GROWTH_FACTOR);
    }
    public LongAvlTree(String name) {
        this(name, INITIAL_CAPACITY, GROWTH_FACTOR);
    }

    public LongAvlTree(String name, int initialCapacity) {
        this(name, initialCapacity, GROWTH_FACTOR);
    }

    public LongAvlTree(String name, int initialCapacity, float growthFactor) {
    ...
    */
    ...
    public static class EntryIterator {
        ...
        public void init(LongAvlTree avlTree) {
