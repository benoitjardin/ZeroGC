...
public class DoubleHashSet {
    ...
    public DoubleHashSet(String name) {
        this(name, INITIAL_CAPACITY, GROWTH_FACTOR, LOAD_FACTOR);
    }

    public DoubleHashSet(String name, int initialCapacity) {
        this(name, initialCapacity, GROWTH_FACTOR, LOAD_FACTOR);
    }

    public DoubleHashSet(String name, int initialCapacity, float growthFactor) {
