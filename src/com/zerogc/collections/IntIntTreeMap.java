...
public class IntIntTreeMap extends IntTreeSet {
    ...
    public IntIntTreeMap() {
        this(IntIntTreeMap.class.getSimpleName(), Store.INITIAL_CAPACITY, Store.GROWTH_FACTOR);
    }

    public IntIntTreeMap(String name) {
        this(name, Store.INITIAL_CAPACITY, Store.GROWTH_FACTOR);
    }

    public IntIntTreeMap(String name, int initialCapacity) {
        this(name, initialCapacity, Store.GROWTH_FACTOR);
    }

    public IntIntTreeMap(String name, int initialCapacity, float growthFactor) {
    ...
    public final int insert(int key, int value) {
