...
public class LongIntTreeMap extends LongTreeSet {
    ...
    public LongIntTreeMap() {
    	this(LongIntTreeMap.class.getSimpleName(), Store.INITIAL_CAPACITY, Store.GROWTH_FACTOR);
    }
    
    public LongIntTreeMap(String name) {
        this(name, Store.INITIAL_CAPACITY, Store.GROWTH_FACTOR);
    }

    public LongIntTreeMap(String name, int initialCapacity) {
    	this(name, initialCapacity, Store.GROWTH_FACTOR);
    }

    public LongIntTreeMap(String name, int initialCapacity, float growthFactor) {
