...
public class ObjectAvlTree {
    ...
    public ObjectAvlTree() {
        this(ObjectAvlTree.class.getSimpleName(), INITIAL_CAPACITY, GROWTH_FACTOR);
    }
    public ObjectAvlTree(String name) {
        this(name, INITIAL_CAPACITY, GROWTH_FACTOR);
    }

    public ObjectAvlTree(String name, int initialCapacity) {
        this(name, initialCapacity, GROWTH_FACTOR);
    }

    public ObjectAvlTree(String name, int initialCapacity, float growthFactor) {
    ...
    */
    ...
    public static class EntryIterator {
        ...
        public void init(ObjectAvlTree avlTree) {
