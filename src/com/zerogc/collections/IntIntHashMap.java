...
public class IntIntHashMap extends IntHashSet {
	private int[] value;
    ...
    public IntIntHashMap() {
    	this(IntIntHashMap.class.getSimpleName(), INITIAL_CAPACITY, GROWTH_FACTOR);
    }
    
    public IntIntHashMap(String name) {
        this(name, INITIAL_CAPACITY, GROWTH_FACTOR);
    }

    public IntIntHashMap(String name, int initialCapacity) {
    	this(name, initialCapacity, GROWTH_FACTOR);
    }

    public IntIntHashMap(String name, int initialCapacity, float growthFactor) {
