...
public class ObjectList {
    ...
    public ObjectList() {
        this(ObjectList.class.getSimpleName(), Store.INITIAL_CAPACITY, Store.GROWTH_FACTOR);
    }
    ...
    public ObjectList(String name, int initialCapacity) {
        this(name, initialCapacity, Store.GROWTH_FACTOR);
    }

    public ObjectList(String name, int initialCapacity, float growthFactor) {
        this(name, new Store(name, initialCapacity, growthFactor));
    }

    public ObjectList(String name, Store store) {
        this.log = LogManager.getLogger(name);
        this.store = store;
    }
    ...
    public int addFirst(Object key) {
        int entry = newEntry();
    ...
    public static class EntryIterator {
        ...
        public void init(ObjectList list) {
            this.list = list;
            entry = -1;
