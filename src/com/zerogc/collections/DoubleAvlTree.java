...
public class DoubleAvlTree {
    ...
    public DoubleAvlTree() {
        this(DoubleAvlTree.class.getSimpleName(), INITIAL_CAPACITY, GROWTH_FACTOR);
    }
    public DoubleAvlTree(String name) {
        this(name, INITIAL_CAPACITY, GROWTH_FACTOR);
    }

    public DoubleAvlTree(String name, int initialCapacity) {
        this(name, initialCapacity, GROWTH_FACTOR);
    }

    public DoubleAvlTree(String name, int initialCapacity, float growthFactor) {
    ...
    public int insertMulti(double key) {
        int parent = -1;
        int entry = root;
        int cmp = 0;
    ...
    */
    ...
    public static class EntryIterator {
        ...
        public void init(DoubleAvlTree avlTree) {
