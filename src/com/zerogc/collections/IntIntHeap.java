...
public class IntIntHeap extends IntHeap {
    private int[] value;
    ...
    public IntIntHeap() {
        this(IntIntHeap.class.getSimpleName(), INITIAL_CAPACITY, GROWTH_FACTOR);
    }

    public IntIntHeap(String name) {
        this(name, INITIAL_CAPACITY, GROWTH_FACTOR);
    }

    public IntIntHeap(String name, int initialCapacity) {
        this(name, initialCapacity, GROWTH_FACTOR);
    }

    public IntIntHeap(String name, int initialCapacity, float growthFactor) {
