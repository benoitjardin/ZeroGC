...
public class LongHashSet {
    ...
    public LongHashSet() {
        this(LongHashSet.class.getSimpleName(), INITIAL_CAPACITY, GROWTH_FACTOR, LOAD_FACTOR);
    }
    public LongHashSet(String name) {
        this(name, INITIAL_CAPACITY, GROWTH_FACTOR, LOAD_FACTOR);
    }

    public LongHashSet(String name, int initialCapacity) {
        this(name, initialCapacity, GROWTH_FACTOR, LOAD_FACTOR);
    }

    public LongHashSet(String name, int initialCapacity, float growthFactor) {
        this(name, initialCapacity, growthFactor, LOAD_FACTOR);
    }

    public LongHashSet(String name, int initialCapacity, float growthFactor, float loadFactor) {
    ...
    public static class EntryIterator {
    	...
    	public void init(LongHashSet hashTable) {
