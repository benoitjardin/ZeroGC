...
public class ObjectRbTree {
    ...
    public ObjectRbTree() {
    	this(ObjectRbTree.class.getSimpleName(), INITIAL_CAPACITY, GROWTH_FACTOR);
    }
    
    public ObjectRbTree(String name) {
        this(name, INITIAL_CAPACITY, GROWTH_FACTOR);
    }

    public ObjectRbTree(String name, int initialCapacity) {
    	this(name, initialCapacity, GROWTH_FACTOR);
    }

    public ObjectRbTree(String name, int initialCapacity, float growthFactor) {
    ...
    public static class EntryIterator {
    	private ObjectRbTree rbTree;
    	private int entry;
    	private int nextEntry;
    	
    	/** Initialize the iterator at the beginning of the collection. */
    	public void init(ObjectRbTree rbTree) {
    		this.rbTree = rbTree;
    		entry = -1;
