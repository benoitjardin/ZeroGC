...
public class IntList {
    ...
    public IntList() {
        this(IntList.class.getSimpleName(), Store.INITIAL_CAPACITY, Store.GROWTH_FACTOR);
    }
    ...
    public IntList(String name, int initialCapacity) {
        this(name, initialCapacity, Store.GROWTH_FACTOR);
    }

    public IntList(String name, int initialCapacity, float growthFactor) {
        this(name, new Store(name, initialCapacity, growthFactor));
    }

    public IntList(String name, Store store) {
        this.log = LogManager.getLogger(name);
        this.store = store;
    }
