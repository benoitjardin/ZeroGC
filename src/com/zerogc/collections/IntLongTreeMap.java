...
public class IntLongTreeMap extends IntTreeSet {
    ...
    public IntLongTreeMap() {
        this(IntLongTreeMap.class.getSimpleName(), Store.INITIAL_CAPACITY, Store.GROWTH_FACTOR);
    }

    public IntLongTreeMap(String name) {
        this(name, Store.INITIAL_CAPACITY, Store.GROWTH_FACTOR);
    }

    public IntLongTreeMap(String name, int initialCapacity) {
        this(name, initialCapacity, Store.GROWTH_FACTOR);
    }

    public IntLongTreeMap(String name, int initialCapacity, float growthFactor) {
