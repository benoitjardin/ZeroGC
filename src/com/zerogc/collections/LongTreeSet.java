...
public class LongTreeSet {
    ...
    private int size = 0;
    private int root = -1;
    private Comparator.LongComparator comparator = new Comparator.LongComparator(); 
    ...
    public LongTreeSet() {
    	this(LongTreeSet.class.getSimpleName(), Store.INITIAL_CAPACITY, Store.GROWTH_FACTOR);
    }
    
    public LongTreeSet(String name) {
        this(name, Store.INITIAL_CAPACITY, Store.GROWTH_FACTOR);
    }

    public LongTreeSet(String name, int initialCapacity) {
    	this(name, initialCapacity, Store.GROWTH_FACTOR);
    }

    public LongTreeSet(String name, int initialCapacity, float growthFactor) {
    	this(name, new Store(name, initialCapacity, growthFactor));
    }
    
    public LongTreeSet(String name, Store store) {
    	this.log = new Logger(name);
    	this.store = store;
    }
