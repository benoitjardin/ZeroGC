...
public class IntRbTree {
    ...
    public IntRbTree() {
    	this(IntRbTree.class.getSimpleName(), INITIAL_CAPACITY, GROWTH_FACTOR);
    }
    
    public IntRbTree(String name) {
        this(name, INITIAL_CAPACITY, GROWTH_FACTOR);
    }

    public IntRbTree(String name, int initialCapacity) {
    	this(name, initialCapacity, GROWTH_FACTOR);
    }

    public IntRbTree(String name, int initialCapacity, float growthFactor) {
