...
public class IntTreeSet {
    ...
    private int size = 0;
    private int root = -1;
    private Comparator.IntComparator comparator = new Comparator.IntComparator(); 
    ...
    public IntTreeSet() {
        this(IntTreeSet.class.getSimpleName(), Store.INITIAL_CAPACITY, Store.GROWTH_FACTOR);
    }

    public IntTreeSet(String name) {
        this(name, Store.INITIAL_CAPACITY, Store.GROWTH_FACTOR);
    }

    public IntTreeSet(String name, int initialCapacity) {
        this(name, initialCapacity, Store.GROWTH_FACTOR);
    }

    public IntTreeSet(String name, int initialCapacity, float growthFactor) {
        this(name, new Store(name, initialCapacity, growthFactor));
    }

    public IntTreeSet(String name, Store store) {
        this.log = LogManager.getLogger(name);
        this.store = store;
    }
