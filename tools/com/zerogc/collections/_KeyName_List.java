...
public class _KeyName_List {
    ...
    public _KeyName_List() {
        this(_KeyName_List.class.getSimpleName(), Store.INITIAL_CAPACITY, Store.GROWTH_FACTOR);
    }

    public _KeyName_List(String name) {
        this(name, Store.INITIAL_CAPACITY, Store.GROWTH_FACTOR);
    }

    public _KeyName_List(String name, int initialCapacity) {
        this(name, initialCapacity, Store.GROWTH_FACTOR);
    }

    public _KeyName_List(String name, int initialCapacity, float growthFactor) {
    	this(name, new Store(name, initialCapacity, growthFactor));
    }
    
    public _KeyName_List(String name, Store store) {
    	this.log = new Logger(name);
    	this.store = store;
    }
    ...
    public int addFirst(_KeyType_ key) {
    	int entry = newEntry();
    ...
    public int addLast(_KeyType_ key) {
    	int entry = newEntry();
    ...
    public static class EntryIterator {
    	...
    	public void init(_KeyName_List list) {
    		this.list = list;
    		entry = -1;
