...
public class _KeyName_RbTree {
    ...
    public _KeyName_RbTree() {
        this(_KeyName_RbTree.class.getSimpleName(), INITIAL_CAPACITY, GROWTH_FACTOR);
    }

    public _KeyName_RbTree(String name) {
        this(name, INITIAL_CAPACITY, GROWTH_FACTOR);
    }

    public _KeyName_RbTree(String name, int initialCapacity) {
        this(name, initialCapacity, GROWTH_FACTOR);
    }

    public _KeyName_RbTree(String name, int initialCapacity, float growthFactor) {
    ...
    public static class EntryIterator {
        private _KeyName_RbTree rbTree;
        private int entry;
        private int nextEntry;

        /** Initialize the iterator at the beginning of the collection. */
        public void init(_KeyName_RbTree rbTree) {
            this.rbTree = rbTree;
            entry = -1;
