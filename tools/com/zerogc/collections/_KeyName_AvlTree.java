...
public class _KeyName_AvlTree {
	...
	public _KeyName_AvlTree() {
		this(_KeyName_AvlTree.class.getSimpleName(), INITIAL_CAPACITY, GROWTH_FACTOR);
	}
	public _KeyName_AvlTree(String name) {
		this(name, INITIAL_CAPACITY, GROWTH_FACTOR);
	}

	public _KeyName_AvlTree(String name, int initialCapacity) {
		this(name, initialCapacity, GROWTH_FACTOR);
	}

	public _KeyName_AvlTree(String name, int initialCapacity, float growthFactor) {
    ...
    */
    ...
    public static class EntryIterator {
    	private _KeyName_AvlTree avlTree;
    	private int entry;
    	...
    	public void init(_KeyName_AvlTree avlTree) {
