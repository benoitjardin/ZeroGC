...
public class GeneratorMessages extends GeneratorBase {
    static final String PACKAGE = "com.zerogc.messages";
...
*/
                ...
                printStream.println("import com.zerogc.util.ByteSlice;");
                printStream.println("import com.zerogc.util.ByteStringBuilder;");
                printStream.println("import com.zerogc.util.ByteUtils;");
                printStream.println();
                
                printStream.println("public class " + pascal(prefix)+pascal(messageName) + " {");
                ...
                printStream.println();
                printStream.println("    public ByteStringBuilder toString(ByteStringBuilder sb) {");
                ...
                printStream.println("        return toString(new ByteStringBuilder()).toString();");
                printStream.println("    }");
                printStream.println("}");
                printStream.close();
