...
public class GeneratorStores extends GeneratorBase {
    static final String PACKAGE = "com.zerogc.stores";
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException
    {
        if (location.equals("/xs:schema/xs:element")) {
            try {
                ...
                printStream.println("import com.zerogc.util.Level;");
                printStream.println("import com.zerogc.util.Logger;");
                printStream.println();
                ...
                printStream.println("        log = new Logger(name);");
